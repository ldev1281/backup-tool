...
```bash
wget -O limbo-backup.deb https://github.com/ldev1281/backup-tool/releases/download/v0.5/limbo-backup_v0.6_all.deb
```
...
For detailed instructions on how to prepare and publish a new release, see the [RELEASE_GUIDE.md](./RELEASE_GUIDE.md).
